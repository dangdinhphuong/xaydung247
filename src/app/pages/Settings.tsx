      ...
      <div className="space-y-3 px-4 lg:space-y-6 lg:px-0">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              <Link to="/settings/templates/new" className="flex items-center gap-3 rounded-lg border p-4 transition-colors hover:bg-gray-50 active:bg-gray-100">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-gray-900">Mẫu in hóa đơn</p>
                  <p className="text-sm text-gray-500">Tùy chỉnh bố cục in bằng HTML</p>
                </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Tùy chỉnh bố cục in hóa đơn bằng HTML và placeholder, có xem trước trực tiếp.
            </CardDescription>
          </CardHeader>
          <CardContent>
